            ...
            columns: [
                {
                    ...
                    cards : [
                        { id: 'card-1', boardId: 'board-1', columnId: 'column-1', title: 'title card 1', cover: 'https://taimienphi.vn/tmp/cf/aut/anh-gai-xinh-1.jpg' },
                ...
                },
                {
                    ...
                    cards : [
                        { id: 'card-11', boardId: 'board-1', columnId: 'column-2', title: 'title card 11', cover: null },
                        { id: 'card-12', boardId: 'board-1', columnId: 'column-2', title: 'title card 12', cover: null },
                        { id: 'card-13', boardId: 'board-1', columnId: 'column-2', title: 'title card 13', cover: null }
                    ]
                }
            ]
        }
